...
function ask_question($rid,$cid,$week) {
	...
	$output .= '<script>
				$("#question_section").click(function(){
					if (!$(this).hasClass("not_loggedin") && !$(this).hasClass("not_belonged") && !$(this).hasClass("not_allowed") && !$(this).hasClass("is_admin") && !$(this).hasClass("not_enroled") && !$(this).hasClass("no_course") || (!$(this).hasClass("is_admin") && $(this).hasClass("guest_mode"))) {
						$("#question_label").text("");
