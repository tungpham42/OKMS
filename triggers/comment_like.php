...
if (isset($_POST['comid']) && isset($_SESSION['uid'])) {
	...
	if ($count == 0) {
		$sql_in = "INSERT INTO ".PREFIX."COMMENT_VOTE(User_ID,Comment_ID,CommentVote_Like,CommentVote_Dislike) VALUES('".$uid."','".$comid."','1','0')";
		mysql_query($sql_in);
		...
		mysql_query("UPDATE ".PREFIX."COMMENT_VOTE c SET c.CommentVote_Like = 1 WHERE c.Comment_ID='".$comid."' AND c.User_ID='".$uid."'");
