...
?>
	<div id="header-login-form" class="logged_in">
		<a class="avatar" href="?p=user/<?php print $_SESSION['uid']; ?>"><img src="<?php print "http://0.gravatar.com/avatar/".md5(strtolower(trim($email)))."?d=".$default."&s=".$size; ?>" width="24px" /></a>
