...
if (isset($_SESSION['uid'])):
	...
	echo '<a class="author" href="/user/'.$user['User_Username'].'"><img alt="'.$user['User_Username'].'" src="'.$grav_url.'" width="40px" height="40px"/><div class="name">'.((isset($user['User_Fullname'])) ? $user['User_Fullname']: $user['User_Username']).'</div></a>'
?>
<?php
endif;
?>
