...
<script type="text/javascript" charset="utf-8">
	$( "#semester_start_date" ).datepicker({ dateFormat: "yy-mm-dd" , changeYear: true , yearRange: "1920:2040" , defaultDate: '<?php echo date('Y-m-d'); ?>'});
	$( "#semester_end_date" ).datepicker({ dateFormat: "yy-mm-dd" , changeYear: true , yearRange: "1920:2040" , defaultDate: '<?php echo date('Y-m-d'); ?>'});
</script>
