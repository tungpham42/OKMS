...
<form id="form" method="post" action="">
	...
	<table>
		<tr>
			...
			<td><input type="text" name="semester_code" size="60" maxlength="128" class="required" value="<?php echo $old_semester_code; ?>" /></td>
		</tr>
		<tr>
			<td><label for="semester_start_date">Semester start date:</label></td>
			<td><input id="semester_start_date" type="text" name="semester_start_date" size="60" maxlength="128" class="required" value="<?php echo date('Y-m-d',$old_semester_start_date); ?>" /></td>
		</tr>
		<tr>
			<td><label for="semester_end_date">Semester end date:</label></td>
			<td><input id="semester_end_date" type="text" name="semester_end_date" size="60" maxlength="128" class="required" value="<?php echo date('Y-m-d',$old_semester_end_date); ?>" /></td>
		</tr>
		<tr>
...
<script type="text/javascript" charset="utf-8">
	$( "#semester_start_date" ).datepicker({ dateFormat: "yy-mm-dd" , changeYear: true , yearRange: "1920:2020" , defaultDate: '<?php echo date('Y-m-d',$old_semester_start_date); ?>'});
	$( "#semester_end_date" ).datepicker({ dateFormat: "yy-mm-dd" , changeYear: true , yearRange: "1920:2020" , defaultDate: '<?php echo date('Y-m-d',$old_semester_end_date); ?>'});
</script>
