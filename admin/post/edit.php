...
$post = post_load($pid);
$uid = $_SESSION['uid'];
$old_cid = isset($_POST['old_cid']) ? $_POST['old_cid']: '';
$old_week = isset($_POST['old_week']) ? $_POST['old_week']: '';
$old_title = isset($_POST['old_title']) ? $_POST['old_title']: '';
$old_url = isset($_POST['old_url']) ? $_POST['old_url']: '';
$old_body = isset($_POST['old_body']) ? $_POST['old_body']: '';
$old_answer = isset($_POST['old_answer']) ? $_POST['old_answer']: '';
