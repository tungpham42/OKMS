...
if (isset($_POST['submit'])):
	...
	echo 'Course edited. Click <a href="/course">here</a> to view created courses';
endif;
?>
<form id="form" method="post" action="">
	...
	<table>
		<tr>
			...
			<td><input type="text" name="course_code" value="<?php echo $code; ?>" size="60" maxlength="128" class="required" /></td>
		</tr>
		<tr>
			<td><label for="course_name">New course's name:</label></td>
			<td><input type="text" name="course_name" value="<?php echo $name; ?>" size="60" maxlength="128" class="required" /></td>
		</tr>
		<tr>
